...
for Chinese.)</p>''')
        ...
        explanation.setText(
            _(u'Please edit the texts below or change the language.'))
...
'''))
        gf_layout.addWidget(gtts_head_label, 0, 0, 1, 3)
        for num, (source, dest, text, base, ruby) \
            ...
            if text:
                gf_layout.addWidget(ledit, num + 1, 1, 1, 2)
                ledit.setToolTip(
